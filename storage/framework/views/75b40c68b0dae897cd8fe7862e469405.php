<div class="bg-[#06080d] p-4 rounded">
    ...
    <form method="POST" action="<?php echo e(route('trade.store')); ?>" >
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-4">
            ...
            <select class="w-full bg-[#0b0f19] p-2 rounded border border-gray-700" name="pair" id="pair">
                <?php $__currentLoopData = $pairs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pair): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($pair->binance_symbol); ?>"><?php echo e($pair->symbol); ?></option>
...
<?php /**PATH C:\Users\Phinehas KwakuFix\Herd\crypto-invest\resources\views/user/trade/form.blade.php ENDPATH**/ ?>