...
<section class="py-24">
    <h2 class="text-4xl font-bold text-center mb-16">
        Why Choose <span class="text-indigo-400"><?php echo e(settings('site_name')); ?></span>
    </h2>
...
<section class="py-24 bg-black/30 rounded-3xl">
    ...
    <div class="grid md:grid-cols-3 gap-8">
        <?php $__currentLoopData = [
            ...
            ['Advanced','25%','14 Days'],
            ['Premium','50%','30 Days']
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$name,$roi,$duration]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bg-gradient-to-br from-indigo-600/20 to-purple-600/10 p-8 rounded-2xl border border-white/10">
            <h3 class="text-2xl font-bold mb-4"><?php echo e($name); ?></h3>
            <p class="text-gray-300 mb-2">ROI: <strong><?php echo e($roi); ?></strong></p>
            <p class="text-gray-300 mb-6">Duration: <?php echo e($duration); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Phinehas KwakuFix\Herd\crypto-invest\resources\views/welcome.blade.php ENDPATH**/ ?>